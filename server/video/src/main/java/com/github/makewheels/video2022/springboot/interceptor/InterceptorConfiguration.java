...
public class InterceptorConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(getCheckTokenInterceptor())
                ...
                .addPathPatterns("/transcode/local/createTranscode")
                .addPathPatterns("/transcode/local/finishTranscode")
                .addPathPatterns("/cover/local/createCover")
                .addPathPatterns("/cover/local/finishCover")
