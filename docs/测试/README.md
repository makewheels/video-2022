...
| 播放与统计 | [5-播放与统计测试](5-播放与统计测试.md) | 3 | 28 | 观看记录、心跳进度、流量统计 |
...
| Playwright 前端 | [10-Playwright前端测试](10-Playwright前端测试.md) | 9 | 80 | 行为交互、E2E 流程、前端样式、全局配置、登录/上传/观看页、UX 组件 |
